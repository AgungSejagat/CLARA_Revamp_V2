...
class _DeviceScreenState extends State<DeviceScreen> {
  ...
  void initState() {
    ...
    super.initState(); //Super ini untuk memanggil fungsi yang ada di parent class
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder(
          future:
              context.read<DeviceProvider>().getLampById(widget.device.espId), //context.read serupa dengan provider.of yng dimana hanya untuk memanggil provider
          builder: (context, snapshot) {
            if (snapshot.hasError) { //Snapshot untuk mengambil data kondisi terkin
